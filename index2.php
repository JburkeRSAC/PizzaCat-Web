...
<script>
    $(document).ready( function(){
        ...
        $("body").toasty(); 
        $("#toasty-button").click( function(){             $("body").toasty('pop');
        });
...
<center>
<BR>
<h1>Multiple-File .EML Upload Mode with Reverse Sort</h1>
<CENTER>
...
<br><b>Please upload a .zip file to extract data from:</b><br><br><input name="uploaded" type="file"/><br/>
